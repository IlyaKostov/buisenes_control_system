...
from src.schemas.struc_adm import CreateStructAdm, StructAdmCreateResponse, StructAdmDeleteResponse, UpdateStructAdm
...
async def update_department(
    ...
    updated_department: StructAdmModel = (
        await department_service.update_department(department_id, department_data, admin_account)
    )
